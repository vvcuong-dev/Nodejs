...
/**
 * 2. Các FLAG dành cho việc ghi
 *  - 'w': Mở file để ghi
 *      - mở file đã tồn tại: Nội dung cũ sẽ bị xóa sạch (truncate) để ghi mới
 *      - nếu file chưa tồn tại: Mở 1 file mới sẽ được tạo
 *  - 'wx': tương tự như 'w' nhưng sẽ thất bại nếu file đã tồn tại (chế độ độc quyền)
 *  - 'w+': mở file để cả đọc và ghi
 *      - nếu file đã tồn tại: Nội dung cũ bị xóa
 *      - nếu chưa có: tạo file mới
 *  - 'wx+': tương tự như 'w+' nhưng sẽ thất bại nếu đường dẫn đã tồn tại
 */
